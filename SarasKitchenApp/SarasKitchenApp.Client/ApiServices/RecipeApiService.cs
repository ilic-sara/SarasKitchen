    ...
    public class RecipeApiService
    {
        ...
        public async Task<List<Recipe>> GetRecipesByCategory(string id, int startIndex = 0)
        {
            try
            {
                var responseData = await _jsRuntime.InvokeAsync<List<Recipe>>(
                "apiClient.get",
                $"recipe/category?id={id}&?startIndex={startIndex}&numberOfObjects={PaginationSettings.RecipesPerPage}"
                );
        ...
        public async Task<List<Recipe>> GetRecipesByCuisine(string id, int startIndex = 0)
        {
            try
            {
                var responseData = await _jsRuntime.InvokeAsync<List<Recipe>>(
                "apiClient.get",
                $"recipe/cuisine?id={id}&startIndex={startIndex}&numberOfObjects={PaginationSettings.RecipesPerPage}"
                );
        ...
        public async Task<List<Recipe>> GetRecipesByDiet(string id, int startIndex = 0)
        {
            try
            {
                var responseData = await _jsRuntime.InvokeAsync<List<Recipe>>(
                "apiClient.get",
                $"recipe/diet?id={id}&startIndex={startIndex}&numberOfObjects={PaginationSettings.RecipesPerPage}"
                );
        ...
        public async Task<List<Recipe>> GetRecipesByMethod(string id, int startIndex = 0)
        {
            try
            {
                var responseData = await _jsRuntime.InvokeAsync<List<Recipe>>(
                "apiClient.get",
                $"recipe/method?id={id}&startIndex={startIndex}&numberOfObjects={PaginationSettings.RecipesPerPage}"
                );
        ...
        public async Task<List<Recipe>> GetRecipesByName(string name, int startIndex = 0)
        {
            try
            {
                var responseData = await _jsRuntime.InvokeAsync<List<Recipe>>(
                "apiClient.get",
                $"recipe/name?name={name}&startIndex={startIndex}&numberOfObjects={PaginationSettings.RecipesPerPage}"
                );
        ...
        public async Task<List<Recipe>> GetRecipesByIngredients(string ingredients, int startIndex = 0)
        {
            try
            {
                var responseData = await _jsRuntime.InvokeAsync<List<Recipe>>(
                "apiClient.get",
                $"recipe/ingredients?ingredients={ingredients}&startIndex={startIndex}&numberOfObjects={PaginationSettings.RecipesPerPage}"
                );
