...
namespace Repositories
{
    public interface IBaseRepository<TEntity>
    {
        ...
        Task<List<TEntity>> PaginationSearchAsync(int startIndex, int numberOfObjects);
    ...
    public class BaseRepository<TEntity> : IBaseRepository<TEntity> where TEntity : Base
    {
        ...
        public async Task<List<TEntity>> PaginationSearchAsync(int startIndex, int numberOfObjects)
        {
            try
            {
                var filter = Builders<TEntity>.Filter.Empty;
